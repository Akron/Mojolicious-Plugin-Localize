...
L<languages|Mojolicious::Plugin::Localize::Languages>.
...
=head2 loc_for
  ...
  %# In templates
  %= loc 'welcome', { welcome_ => sub { $_->languages } }, begin
...
the L<languages|Mojolicious::Plugin::Localize::Languages> helper.
